...
const services = ['payment-service', 'user-service', 'api-gateway',
  'auth-service', 'notification-service', 'analytics-service', 'cache-service',
  'logging-service', 'file-storage-service', 'email-service',
